  ...
  return (
    <section className="py-16 bg-primary/5">
      <div className="learnq-container">
        <div className="bg-primary text-white rounded-xl p-8 md:p-12 flex flex-col md:flex-row items-center gap-8">
          <div className="md:w-1/2">
            <h3 className="text-xl md:text-2xl font-bold mb-6">
              Connect with Top SAT Achievers
            </h3>
          ...
          <div className="md:w-1/2 relative h-40 md:h-60">
